...
-- essa variavel foi declarada no corpo ou no parametro
    all f:Function| 
        (all st1: f.stmt.elems | st1 in ifDef => 
            ...
            (st1.cmd.(VarAttrib<:v) in f.param)) 
    ...
    all f:Function| 
        (all st1: f.stmt.elems | st1 in ifDef => 
            (some st2: f.stmt.elems | 
                ...
                st2.(LocalVarDecl<:v) = st1.cmd.(VarAttrib<:v) and f.stmt.idxOf [st2] < f.stmt.idxOf [st1]) or
            (st1.else_.(VarAttrib<:v) in f.param))
...
--------------------------------------------------------------------------
	...
	all att: VarAttrib | #att.v2 > 0 => att.v.type = att.v2.type && att.v != att.v2
-- toda funcao que tiver uma atribuicao de variavel
-- essa variavel foi declarada no corpo ou no parametro
    all f:Function| 
        (all st1: f.stmt.elems | st1 in VarAttrib => 
            (some st2: f.stmt.elems | 
                st2 in LocalVarDecl and st2.(LocalVarDecl<:v) = st1.(VarAttrib<:v2) and f.stmt.idxOf [st2] < f.stmt.idxOf [st1] ) or
            st1.(VarAttrib<:v2) in f.param) 
...
-- essa variavel foi declarada no corpo ou no parametro
    all f:Function| 
        (all st1: f.stmt.elems | st1 in ifDef => 
            (some st2: f.stmt.elems | 
                st2 in LocalVarDecl and st2.(LocalVarDecl<:v) = st1.cmd.(VarAttrib<:v2) and 
                st2.(LocalVarDecl<:v) = st1.cmd.(VarAttrib<:v2) and f.stmt.idxOf [st2] < f.stmt.idxOf [st1]) or
            (st1.cmd.(VarAttrib<:v2) in f.param)) 
...
-- essa variavel foi declarada no corpo ou no parametro
    all f:Function| 
        (all st1: f.stmt.elems | st1 in ifDef => 
            (some st2: f.stmt.elems | 
                st2 in LocalVarDecl and st2.(LocalVarDecl<:v) = st1.else_.(VarAttrib<:v2) and 
                st2.(LocalVarDecl<:v) = st1.cmd.(VarAttrib<:v2) and f.stmt.idxOf [st2] < f.stmt.idxOf [st1]) or
            (st1.else_.(VarAttrib<:v2) in f.param))

#VarAttrib > 0
some att: VarAttrib | #att.v2 = 0
some att: VarAttrib | #att.v2 > 0
}
...
// vamos considerar sequencias de statements menores que 5
    all f: Function | #f.stmt < 6 
//	some f: Function | #f.stmt >2 
