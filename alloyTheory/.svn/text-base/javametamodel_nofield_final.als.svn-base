...
//        return this.k();
//        return super.k();
//        return A.this.k(); -> implement in Java whether use this or qualified this
...
pred someOverriding[] {
  some disj m1,m :Method | m1.id = m.id && #m1.param  = 0 && #m.param = 0 && m1.b + m.b in LiteralValue //&& sameHierarchy[m1,m]
}
...
// one disj m1,m:Method | m1.id = m.id && #m1.param = 0 && (m.param = Int_ || m.param = Long_) && m1.b + m.b in LiteralValue && sameHierarchy[m1,m]
...
pred someOverloading[t1:Type,t2:Type] {
